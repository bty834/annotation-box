...
public class OnsMessageListenerContainer implements InitializingBean, DisposableBean, OnsListenerContainer, SmartLifecycle {
    ...
    public void setMessageListenerList(List<MessageListener> messageListenerList) {
